...
namespace Microsoft.BotBuilderSamples
{
    ...
    public class QnABot : IBot
    {
        ...
        private const string WelcomeText = @"This Bot will help you get more information about Strathmore IT programmes and Financial aid.
        ...
        public async Task OnTurnAsync(ITurnContext turnContext, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (turnContext.Activity.Type == ActivityTypes.Message)
            {
                ...
                {
                    var msg = @"No answers were found for that particular question. Could you please rephrase the question or try asking another related question?";
            ...
            foreach (var member in turnContext.Activity.MembersAdded)
            {
                if (member.Id != turnContext.Activity.Recipient.Id)
                {
                    await turnContext.SendActivityAsync(
                        $"Hi ! Welcome to Codess 2019 Bot Sevice. {WelcomeText}",
